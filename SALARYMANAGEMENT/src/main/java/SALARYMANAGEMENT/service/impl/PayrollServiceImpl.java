...
public class PayrollServiceImpl implements PayrollService {
    ...
    @Override
    public List<PayrollDTO> searchPayrollByDuration(Long idDuration){
        ...
        //cũng có thể viết tắt như này luôn
        //return payrollRepository.findByDuration_Id(idDuration).stream().map(this:: toDTO).collect(Collectors.toList())
